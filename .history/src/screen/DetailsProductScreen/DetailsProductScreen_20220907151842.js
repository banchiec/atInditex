...
const DetailsProductScreen = () => {
  ...
  const [activeOptionClass, setActiveOptionClass] = useState(null)
  ...
  const handleToggleActive = (e) => {
		...
		activeOption ? setActiveOptionClass('active_option') : setActiveOptionClass('')
		activeOption ? setOption(e.target.name): setOption(null)
