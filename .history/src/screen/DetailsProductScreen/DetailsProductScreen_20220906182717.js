    ...
    <div>
      ...
      (
        ...
        <ContainerDetails>
          ...
          <div>
            <Details>
              <DetailsItem>Marca: {product.brand}</DetailsItem>
              <DetailsItem>Modelo: {product.model}</DetailsItem>
              ...
              <DetailsItem>{product.secondaryCmera}</DetailsItem>
              <DetailsItem>{product.dimentions}</DetailsItem>
            </Details>
            <Actions>
              <h1>Local</h1>
            </Actions>
