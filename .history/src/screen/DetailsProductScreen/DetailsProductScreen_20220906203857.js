...
import { Actions, ButtonDescription, ContainerDetails, Details, DetailsItem, Image, ImageProduct } from "./styles/detailsProductScreenStyled";
      ...
      (
        ...
        <ContainerDetails>
          ...
          <div>
            ...
            <Actions>
              <ButtonDescription>Almacenamiento</ButtonDescription>
              {product?.colors?.map((color) => {
                return(
                  <ButtonDescription key={color} background={`${color}`}>
                    {color}
                  </ButtonDescription>
                )
              })}
